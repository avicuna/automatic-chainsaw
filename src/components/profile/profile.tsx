    ...
    public render() {
        ...
        return (
            <div>
                ...
                <br/>
                <br/>
                <p className="h2-responsive text-center">{this.props.firstName + " " + this.props.lastName}</p>
                <div id="profile">
                    <p className="h3-responsive">Account details <Fa icon="pencil" onClick={this.edit} fixed /></p>
                ...
                <div id="profile">
                    ...
                    <p>Height: {this.props.height}(in)</p>
